...
right_entity: "agv:ros:interface:trajectory-status"
target_snapshot: "code-v1"
relation: "describes"
match_score: 100
match_probability: 1.0
match_status: "accepted"
match_reasons: ["ROS 话题名精确命中。"]
...
# 历史 Renew 的轨迹与超声接口集合 → /trajectory_status

## 匹配结论

- 左侧工程结论：[[11_Engineering_Materials/Entities/历史 Renew 的轨迹与超声接口集合|历史 Renew 的轨迹与超声接口集合]]
- 右侧代码实体：[[03_ROS/Interfaces/trajectory-status|/trajectory_status]]
- 关系：`describes`
- 匹配概率：**100%**
- 匹配状态：`accepted`
