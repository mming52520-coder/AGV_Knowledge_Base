...
right_entity: "agv:ros:interface:ultrasonic-status"
target_snapshot: "code-v1"
relation: "specifies_payload_for"
match_score: 100
match_probability: 1.0
match_status: "accepted"
match_reasons: ["异常值到状态语义的映射吻合。"]
