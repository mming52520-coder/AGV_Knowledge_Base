...
review: verified
project: AGV
related_packages: ["[[../Packages/magnetic_controlled_motor]]", "[[../Packages/ultrasonic_controlled_motor]]", "[[../Packages/trajectory_recorder]]", "[[../Packages/remote_ctrl]]", "[[../Packages/wheeltec_base]]", "[[../Packages/analog_controlled_motor]]", "[[../Packages/relay]]", "[[../Packages/agv_mqtt_bridge]]"]
...
- 消费者/客户端：`cmd_vel_adapter`、`analog_controlled_motor`、`relay`、`trajectory_recorder`、`agv_mqtt_bridge`
...
- 三号车 `src/agv_mqtt_bridge/scripts/agv_mqtt_bridge.py:593-595`
