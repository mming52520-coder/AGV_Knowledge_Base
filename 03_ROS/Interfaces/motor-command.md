...
review: verified
project: AGV
related_packages: ["[[../Packages/magnetic_controlled_motor]]", "[[../Packages/ultrasonic_controlled_motor]]", "[[../Packages/trajectory_recorder]]", "[[../Packages/remote_ctrl]]", "[[../Packages/wheeltec_base]]"]
...
- 消费者/客户端：`steering_remote`、`cmd_vel_adapter`、`trajectory_recorder`、`旧 motor_control`
